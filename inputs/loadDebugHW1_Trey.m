...
pars.Body.SH.C(4,2) = 0;  % C31
pars.Body.SH.C(4,3) = 0;   % C32
pars.Body.SH.C(4,4) = 0;    % C33
...
pars.Body.SH.S(3,2) = 1.80326e-4;    % C21
pars.Body.SH.S(3,3) = -9.03867e-7;   % C22
pars.Body.SH.S(4,2) = 0;     % C31
pars.Body.SH.S(4,3) = 0;  % C32
pars.Body.SH.S(4,4) = 0;    % C33
% pars.Body.SH.S(4,2) = 8.1412e-5;     % C31
% pars.Body.SH.S(4,3) = -5.111891e-5;  % C32
% pars.Body.SH.S(4,4) = 4.82403e-4;    % C33
